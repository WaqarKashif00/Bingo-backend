...
// const winRoom = async (room_id, user_id, bingo_tickets) => {
//   try {
//     console.log(room_id, user_id, bingo_tickets);
//     console.log();
//     console.log();
//     console.log();
//     let flagA = false;
...
//     if (!existingRoom) {
//       return { msg: 'Too slow to BINGO.', winner: null, prize: null };
//     }

//     const existingTickets = await new TicketsModel().find({ room_id, user_id });
//     if (!existingTickets) {
//       return { msg: 'Non relevant BINGO tickets.', winner: null, prize: null };
//     }
...
//       await new UserModel(user.id).update({ wallet_balance: (Number(user.wallet_balance) + Number(existingRoom.win)).toFixed(2).toString() });

//       return { msg: 'BINGO!!!', winner: user.name, prize: existingRoom.win };
//     }

//     return { msg: 'Better Luck Next Time!', winner: null, prize: null };
//   } catch (err) {
//     console.error(err.message);
//     return { msg: 'Internal Server Error', winner: null, prize: null };
//   }
// };
